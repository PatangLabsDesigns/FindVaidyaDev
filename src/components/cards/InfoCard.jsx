export default function InfoCard({ icon, title, subtitle, listItems = [], comingSoon }) {
    return (
        <div className="flex flex-col gap-2 items-start p-6 border border-outline rounded-2xl bg-white shadow-md w-full">
            <div className="flex flex-row items-center justify-between w-full">
                ...
                {comingSoon ? <div className="uppercase text-xs px-2 py-1 bg-primary-light text-primary-base font-base font-bold rounded-full">Coming Soon</div> : null}
            </div>
            <div>
